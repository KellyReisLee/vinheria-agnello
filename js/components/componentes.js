  ...
  const headerHTML = `
    <header class="navbar">
      ...
      <nav class="nav-links">
        ...
        <a href="catalogo.html">Nossos Rótulos</a>
        <a href="quiz.html" id="open-quiz">✨ Sommelier Virtual</a>
      </nav>
  ...
  <div class="quiz-footer-content-wrapper">
    <div class="quiz-footer-col quiz-footer-brand-col">
      <div class="quiz-footer-logo-box">
        <img src="./assets/images/logo-white-sem-fundo.png" alt="Logo Vinheria Agnello" class="quiz-footer-logo-img">
        Vinheria Agnello
      </div>
  ...
  <footer class="footer">
    <div class="footer-content">
      <div class="footer-col">
        <div class="footer-logo">
          <img src="./assets/images/logo-white-sem-fundo.png" alt="Logo Vinheria Agnello" class="footer-logo-img">
          Vinheria Agnello
        </div>
      ...
      <div class="footer-col">
        ...
        <ul class="footer-links">
          <li><a href="catalogo.html">Nossa Adega</a></li>
          <li><a href="historia.html">Nossa História</a></li>
          <li><a href="eventos.html">Calculadora de Eventos</a></li>
    ...
    <div class="footer-bottom">
      <div class="footer-bottom-content">
        ...
        <p class="footer-legal-warning">Proibida a venda de bebidas alcoólicas para menores de 18 anos. Beba com
          moderação.</p>
      </div>
    </div>
  </footer>
